...
function AuthPage() {
  ...
  const returnUrl = () =>
    next && next.startsWith("/") ? window.location.origin + next : window.location.origin;
    ...
    <div className="min-h-dvh bg-[oklch(0.18_0.04_245)] text-white">
      ...
      <div className="relative mx-auto flex min-h-dvh max-w-md flex-col px-6 pt-14 pb-8">
        <div className="mb-8 inline-flex w-fit items-center gap-2 rounded-full border border-primary/40 bg-primary/15 px-3 py-1.5 text-xs font-bold uppercase tracking-[0.14em] text-white shadow-[0_0_24px_-8px_oklch(0.56_0.17_195/0.6)]">
          <BrandMark size={16} /> Body Forge AI Coach
        </div>
        ...
        <p className="mt-4 text-lg font-bold leading-snug text-white">
          {isSignup
            ? "Create an account — your AI coach starts now."
        ...
        <form onSubmit={submit} className="mt-9 space-y-4">
          {isSignup && (
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-13 border-white/15 bg-white/[0.06] text-base font-bold text-white placeholder:text-white/80 focus-visible:border-primary focus-visible:ring-primary/40"
              />
            </div>
          )}
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                type="email"
                required
                placeholder="you@ironflex.app"
                className="h-13 border-white/15 bg-white/[0.06] pl-10 text-base font-bold text-white placeholder:text-white/80 focus-visible:border-primary focus-visible:ring-primary/40"
              />
            </div>
          </div>
          <div className="space-y-1.5">
          ...
          <Button
            type="submit"
            disabled={busy}
            className="h-13 w-full rounded-xl bg-gradient-primary text-base font-extrabold tracking-wide text-white shadow-[0_10px_30px_-10px_oklch(0.56_0.17_195/0.7)] hover:brightness-110"
          >
        ...
        <Button
          ...
          disabled={busy}
          variant="outline"
          className="h-13 w-full rounded-xl border-white/20 bg-white/[0.06] text-base font-extrabold text-white hover:bg-white/[0.12] hover:text-white"
        >
        ...
        <button
          ...
          className="mt-8 text-center text-sm font-bold text-white hover:text-white"
        >
          {isSignup ? "Already have an account? " : "New here? "}
          <span className="font-extrabold text-primary underline-offset-4 hover:underline">
