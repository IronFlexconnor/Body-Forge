  ...
  return (
    <AppShell>
      <div className="px-5 pt-12">
        ...
        {user && <WeighInCard userId={user.id} units={units} />}
        ...
        <div className="mb-6 grid grid-cols-2 gap-3">
          ...
          <BigStat
            icon={Activity}
            value={`${(displayVolume(stats.volume, units) / 1000).toFixed(1)}k`}
            label="Total volume"
            sub={`${weightLabel(units)} lifted`}
          />
          <BigStat
            icon={TrendingUp}
