  ...
  head: () => ({
    meta: [
      { title: "Body Forge AI Coach — Your 24/7 Personal Trainer" },
      {
        name: "description",
        content:
          "Custom plans. Real-time form feedback. Nutrition that actually tastes good. Start your free 7-day trial.",
      },
      { property: "og:title", content: "Body Forge AI Coach — Your 24/7 Personal Trainer" },
      {
        property: "og:description",
        content: "Custom plans. Real-time form feedback. Nutrition that actually tastes good.",
      },
    ],
  }),
  component: Welcome,
...
const SLIDES = [
  {
    ...
    bullets: [
      "Picks 4–6 best exercises today",
      "Macros tuned to your body",
      "Adapts every single day",
    ],
  },
  {
    icon: Video,
  ...
  },
  {
    ...
    bullets: [
      "Surprise Me — fresh picks daily",
      "Prep videos under 60s",
      "Diet & allergens respected",
    ],
  },
];
          ...
          <div className="flex flex-1 flex-col justify-center animate-fade-in" key={step}>
            ...
            <ul className="mx-auto mt-7 w-full max-w-sm space-y-2.5">
              {slide.bullets.map((b) => (
                <li
                  key={b}
                  className="flex items-center gap-3 rounded-2xl border border-white/10 bg-surface-elevated px-4 py-3 text-sm font-semibold text-white shadow-card"
                >
    ...
    <div className="relative min-h-dvh overflow-hidden bg-gradient-hero">
      ...
      <div className="relative mx-auto flex min-h-dvh max-w-lg flex-col px-5 pt-10 pb-6 sm:px-6 sm:pt-14 sm:pb-8">
        <div className="flex flex-1 flex-col">
          <div className="mb-5 flex items-center gap-2.5 animate-fade-in">
            <BrandMark size={40} />
          ...
          <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1.5 text-[11px] font-bold uppercase tracking-wider text-white animate-fade-in sm:mb-5 sm:text-xs">
            ...
            The AI coach that adapts to you every day
          </div>
          ...
          >
            ...
            <span className="mt-1.5 block text-white sm:mt-2">Your 24/7 Trainer</span>
          </h1>
            ...
            <div className="relative flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1.5 text-sm font-semibold leading-relaxed text-white">
                  "Hey! I just built tomorrow's session for you — 4 lifts, 38 minutes, and I swapped
                  in higher-protein dinners. Tap below to get started 💪"
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 space-y-3 animate-fade-in">
            ...
            >
              ...
              <div className="mt-2 font-bold leading-tight text-white">
            ...
            >
              ...
              <div className="mt-2 font-bold leading-snug text-white">
                Lengthened-bias work grows muscle ~12% faster
              </div>
              <p className="mt-1 line-clamp-2 text-[11px] font-semibold text-white">
                New 2026 meta finds stretch-position reps drive more hypertrophy at matched effort.
              </p>
            </button>
          </div>
          ...
          <div className="mt-5 grid grid-cols-1 gap-2.5 animate-fade-in">
            {[
              {
                name: "Sarah K.",
                role: "Lost 18 lbs in 12 weeks",
                quote: "Feels like having a coach in my pocket. The form feedback is unreal.",
              },
              {
                name: "Marcus T.",
                role: "Added 40 lbs to squat",
                quote: "Plans adapt to me. I've never been this consistent.",
              },
            ].map((t) => (
              <div
                key={t.name}
                className="flex items-start gap-3 rounded-2xl border border-white/10 bg-surface-elevated p-3.5 shadow-card"
              >
        ...
        <div className="mt-6 space-y-3 sm:mt-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 pt-0.5 text-[11px] font-semibold text-white">
            <span className="inline-flex items-center gap-1">
              <Heart className="h-3 w-3 text-primary" /> No credit card
            </span>
