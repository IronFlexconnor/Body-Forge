...
export const GOAL_CARDS: GoalCard[] = [
  ...
  { id: "bone-health", title: "Post-60 Bone Health", emoji: "🦴", blurb: "Bone density + joint care.", prompt: "Post-60 bone health & joint care — weight-bearing step-ups with support, standing marches, light loaded carries, joint-friendly mobility.", accent: "from-stone-500/30 to-orange-500/10" },
  { id: "post-rehab", title: "Gentle Post-Rehab", emoji: "🩹", blurb: "Easing back after injury or surgery.", prompt: "Gentle post-rehab recovery — pain-free range, isometric holds, banded mobility, light progressive loading, careful weekly progression.", accent: "from-rose-500/30 to-pink-500/10" },
  { id: "active-aging", title: "Active Aging 65+", emoji: "🌅", blurb: "Energy, independence, vitality.", prompt: "Active aging for 65+ — chair-based warm-ups, gentle bodyweight strength, balance circuits, low-impact cardio walks, daily mobility.", accent: "from-indigo-500/30 to-violet-500/10" },
];
